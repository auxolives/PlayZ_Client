// Cold cyan screen tint for PlayZ gas contaminated zones.
class PPERequester_PlayZGasAreaTint extends PPERequester_GameplayBase
{
	...
	// end RGB = 1 - TARGET
	const float R_TARGET = 0.40;
	const float G_TARGET = 0.16;
	const float B_TARGET = 0.04;
